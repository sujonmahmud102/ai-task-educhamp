...
const Navbar = () => {
    ...
    const navItems = <>
        <li className='mr-4 font-semibold lg:hidden block'>
            <Link to="/"> AI Text Generator</Link>
        </li>
        <li className='mr-4'>
            <NavLink
                to='/'
    ...
    return (
        <div className="navbar sticky top-0 z-50 bg-blue-500 text-white">
            <div className="navbar-start">
                ...
                <div className="hidden md:block">
                    <Link to="/" className="btn btn-ghost normal-case text-xl "> AI Text Generator</Link>
                </div>
            </div>
